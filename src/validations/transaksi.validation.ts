...
export const createTransaksiSchema = z.object({
  body: z.object({
    ...
    metode_pembayaran: z.enum(['QRIS', 'TRANSFER', 'CASH'], {
      ...
      invalid_type_error:
        'Metode pembayaran harus "QRIS", "TRANSFER" atau "CASH"',
    }),
...
export const getFilterTransaksiSchema = z.object({
  query: z.object({
    ...
    status_transaksi: z
      .enum(['SUDAH_DIBAYAR', 'BELUM_DIBAYAR'], {
        invalid_type_error:
          'Status transaksi harus "SUDAH DIBAYAR" atau "BELUM DIBAYAR"',
      })
      .optional(),
